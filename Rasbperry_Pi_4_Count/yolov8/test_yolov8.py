...
test_params=[
            ...
            {'model_name':'Helicoverpa_armigera_Yolov8_color_10k_overlap',
                ...
                'load_saved_parameters':'models/helicoverpa_yolov8.pt',
                'test_save_images_path':'Yolov8_Test_10k/Helicoverpa_armigera_color_overlap',
                'size':(480,480), 
                'conf':0.3,
                'iou':0.8,
                'grey':False,
            ...
            {'model_name':'Plodia_interpunctella_Yolov8_color_10k',
                ...
                'load_saved_parameters':'models/plodia_yolov8.pt',
...
#general results
path_general_results='Yolov8_Test_10k/General_Results'
try:
    shutil.rmtree(path_general_results)
except:
    pass    
os.makedirs(path_general_results)
gen_res_logger=init_logger(path_general_results,'Yolov8_Test_10k')
    ...
    if test_param['enable']:
        ...
        for img in full_image_path:
            ...
            if test_param['create_image']:
                image=cv2.putText(image,f"Yolo8: {pred_label}/{label}",(10,20),cv2.FONT_HERSHEY_SIMPLEX,0.8,(255,255,255),1)
