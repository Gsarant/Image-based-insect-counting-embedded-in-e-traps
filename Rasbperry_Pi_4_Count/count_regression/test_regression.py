...
test_params = [
    ...
    {'test_image_path': '../data/Helicoverpa_armigera_crowd_overlap/all_overlap',
     ...
     'grey': False,
     'enable': True,
     'load_saved_parameters': 'models/Helicoverpa_armigera_resnet_HVGA-0.74656951-valloss 0.7465695121458599- CountRegr_Helicoverpa_resnet18_HVGA_ep_104.pt',
    ...
    {'test_image_path': '../data/Helicoverpa_armigera_crowd_overlap/all_overlap',
     ...
     'grey': False,
     'enable': True,
     'load_saved_parameters': 'models/Helicoverpa_armigera_resnet_HVGA-0.69831866-valloss 0.6983186623879841- CountRegr_Helicoverpa_resnet50_HVGA_ep_113.pt',
    ...
    {'test_image_path': '../data/Helicoverpa_armigera_crowd_overlap/all_overlap',
     ...
     'grey': False,
     'enable': False,
     'load_saved_parameters': 'models/Helicoverpa_armigera_vgg16_HVGA-1.11196765-valloss 1.1119676530361176- CountRegr_Helicoverpa_vgg16_HVGA_ep_63.pt',
    ...
    {'test_image_path': '../data/Helicoverpa_armigera_crowd_overlap/all_overlap',
     ...
     'grey': True,
     'enable': False,
     'load_saved_parameters': 'models/Plodia_interpunctella_resnet_HVGA-1.96481650-valloss 1.9648165039394212- CountRegr_Plodia_interpunctella_resnet_HVGA_ep_102.pt',
    ...
    {'test_image_path': '../../data/Helicoverpa_armigera',
     ...
     'grey': True,
     'enable': False,
     'load_saved_parameters': 'models/Helicoverpa_armigera_grey_large_HVGA-18.28486204-valloss 18.284862043799425- CountRegr_Helicoverpa_grey_large_HVGA_ep_93.pt',
    ...
    {'test_image_path': '../data/Plodia_interpunctella',
     ...
     'grey': False,
     'enable': True,
     'load_saved_parameters': 'Plodia_interpunctella_resnet_HVGA-2.07001807-valloss 2.0700180748234622- CountRegr_Plodia_interpunctella_resnet18_HVGA_ep_158.pt',
    ...
    {'test_image_path': '../data/Plodia_interpunctella',
     ...
     'grey': False,
     'enable': True,
     'load_saved_parameters': 'models/Plodia_interpunctella_resnet_HVGA-3.17570898-valloss 3.1757089780724566- CountRegr_Plodia_interpunctella_resnet50_HVGA_ep_49.pt',
    ...
    {'test_image_path': '../data/Plodia_interpunctella',
     ...
     'grey': False,
     'enable': False,
     'load_saved_parameters': 'models/Plodia_interpunctella_vgg16_HVGA-2.08870671-valloss 2.088706708991009- CountRegr_Plodia_interpunctella_vgg16_HVGA_ep_158.pt',
    ...
    {'test_image_path': '../data/Plodia_interpunctella',
     ...
     'grey': True,
     'enable': False,
     'load_saved_parameters': 'models/Plodia_interpunctella_grey_large_HVGA-48.27876088-valloss 48.27876087535511- CountRegr_Plodia_interpunctella_lage_HVGA_ep_2.pt',
    ...
    {'test_image_path': '../data/Plodia_interpunctella',
     ...
     'grey': True,
     'enable': False,
     'load_saved_parameters': 'models/Plodia_interpunctella_grey_small_HVGA-3.1565-last-Plodia_interpunctella_grey_small_HVGA_ep_50.pt',
