...
tflite_parameters=[
                ...
                {'model_name':'Count_Regression_Helicoverpa_resnet50_overlap',
                    ...
                    'path_saved_model_tflite':'models/Helicoverpa_armigera_resnet50_HVGA-0.tflite',
                    'size':(224,224),
                    'grey':False,
                    'enable':True},
                ...
                {'model_name':'Count_Regression_Helicoverpa_resnet18_overlap',
                    'test_image_path':'../data/Helicoverpa_armigera_crowd_overlap/all_overlap',
                    'path_saved_model_tflite':'models/Helicoverpa_armigera_resnet18_HVGA-0.tflite',
                    'size':(224,224),
                    'grey':False,
                    'enable':True},
                ...
                {'model_name':'Count_Regression_plodia_resnet50',
                    ...
                    'path_saved_model_tflite':'models/Plodia_interpunctella_resnet50_HVGA-3.tflite',
                    'size':(224,224),
                    'grey':False,
                    'enable':True},
                #Plodia ResNet18
                {'model_name':'Count_Regression_plodia_resnet18',
                    'test_image_path':'../data/Plodia_interpunctella',
                    'path_saved_model_tflite':'models/Plodia_interpunctella_resnet18_HVGA-2.tflite',
                    'size':(224,224),
                    'grey':False,
                    'enable':True},
